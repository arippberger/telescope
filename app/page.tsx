        ...
        <div className="mx-auto py-32 sm:py-48 lg:py-56">
          <div className="mx-auto max-w-2xl">
            <div className="text-center">
              <span role="img" aria-label="telescope" className="text-9xl">🔭</span>
              <Heading level={1} className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Telescope</Heading>
              <p className="mt-6 text-lg leading-8 text-gray-600">Explore a GitHub user&apos;s stars using the GitHub Graphql API.</p>
            </div>
          </div>
          <SearchStars />
        </div>
